  ...
  return (
    <div className="px-[18px] py-6">
      ...
      <section className="mt-7">
        <h2 className="text-[20px] font-bold text-ink">광고가 나가는 자리</h2>
        <ul className="mt-2 flex flex-col gap-1.5 text-[18px] leading-relaxed text-muted">
      ...
      <section className="mt-7 rounded-card border border-line bg-white p-4">
        <h2 className="text-[19px] font-bold text-ink">알려드립니다</h2>
