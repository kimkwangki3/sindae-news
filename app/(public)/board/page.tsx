          ...
          <li key={p.id}>
            ...
            >
              <div className="flex items-center gap-1.5">
                ...
                {p.orgName && (
                  <span className="max-w-[45%] truncate rounded-full bg-tag-org-bg px-2 py-0.5 text-[15px] font-bold text-tag-org-fg">
                    🏛 {p.orgName}
                  </span>
                )}
                <h4 className="line-clamp-1 flex-1 text-[20px] font-bold">
                  {p.title}
                </h4>
              </div>
              <div className="flex gap-2.5 text-[16px] text-muted">
                <span>{p.author}</span>
