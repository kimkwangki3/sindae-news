...
export default async function WelcomePage() {
  ...
  return (
    <main className="px-[18px] py-10">
      <p className="text-[13px] font-bold text-rose">가입을 마쳤습니다</p>
      <h1 className="mt-2 font-serif text-[26px] leading-snug text-ink">
      ...
      <section className="mt-8 rounded-card border border-line bg-ivory-2 p-5">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mt-4 flex min-h-[52px] items-center justify-center rounded-element bg-[#FEE500] text-[15px] font-bold text-[#191600]"
        >
          카카오톡 채널 추가하기
        </a>
      </section>
