...
export const MEDIA = {
  ...
  kind: "인터넷신문",
  // ⚠️ 발행인 결정(2026-07-31): 개인 성명 대신 직함으로 표기한다.
  // 신문법 제21조는 발행인·편집인의 '성명'을 게재하도록 하고 있어
  // 등록관청 확인이 필요한 항목이다. 성명으로 되돌릴 때는 여기만 고치면 된다.
  publisher: "해룡신문 대표", // 발행인
  editor: "해룡신문 대표", // 편집인
  youthOfficer: "해룡신문 대표", // 청소년보호책임자
  privacyOfficer: "해룡신문 대표", // 개인정보 보호책임자
