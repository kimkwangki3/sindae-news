...
function body(title) {
  return [
    ...
    "현장을 찾은 주민들은 “생활에 실질적인 도움이 된다”며 반겼다. 해룡신문은 앞으로도 우리 동네의 생생한 이야기를 전한다.",
    "자세한 내용과 일정은 해룡면 행정복지센터 및 해룡신문 공지사항에서 확인할 수 있다.",
  ].join("\n\n");
}
