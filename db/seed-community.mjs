...
const MARKET = [
  { category: "share", title: "아기 옷 (6~12개월) 무료로 드려요", neighborhood: "신대지구", body: "아이가 자라서 못 입는 옷들이에요. 상태 좋고 깨끗하게 세탁했습니다. 필요하신 분 댓글 주세요.", is_pinned: true },
  { category: "share", title: "책장 나눔합니다 (직접 가져가실 분)", neighborhood: "복성지구", body: "원목 5단 책장입니다. 이사로 정리해요. 직접 가져가실 분께 무료로 드립니다.", is_pinned: false },
  { category: "request", title: "유아용 카시트 잠깐 빌릴 수 있을까요?", neighborhood: "신대지구", body: "주말에 잠깐 사용할 카시트를 빌리고 싶어요. 대여 가능하신 이웃 계실까요?", is_pinned: false },
  { category: "done", title: "화분 나눔 — 마감되었습니다 🙏", neighborhood: "선월지구", body: "많은 관심 감사합니다. 좋은 분께 잘 전달했어요!", is_pinned: false },
  { category: "share", title: "주방 살림 모음 나눔 (그릇·냄비)", neighborhood: "신대지구", body: "잘 안 쓰는 그릇과 냄비 모음이에요. 필요하신 분께 나눔합니다.", is_pinned: false },
];
...
const BOARD = [
  ...
  { category: "question", title: "신대지구 근처 괜찮은 소아과 있을까요?", body: "아이가 자주 아픈데 친절하고 잘 보는 소아과 추천 부탁드려요!", like_count: 12, view_count: 156, is_pinned: false },
