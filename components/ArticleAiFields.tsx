  ...
  return (
    <div className="flex flex-col gap-4">
      <fieldset className="rounded-card border border-line bg-ivory-2 p-4">
        <legend className="px-1 text-[13px] font-bold">📎 출처 (선택)</legend>
      ...
      <fieldset className="rounded-card border border-line bg-ivory-2 p-4">
        <legend className="px-1 text-[13px] font-bold">🤖 AI 생성 고지</legend>
        <p className="mt-1 text-[12px] leading-relaxed text-muted">
...
function Check({
  ...
  return (
    <label className="flex min-h-[44px] cursor-pointer items-center gap-2.5 text-[13px]">
      <input
        type="checkbox"
        name={name}
