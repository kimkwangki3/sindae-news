      ...
      <ul className="mb-8 flex flex-col gap-2.5">
        {appRows.map((a) => (
          ...
          >
            ...
            {a.interests && (
              <p className="mt-0.5 text-[16px] text-muted">관심: {a.interests}</p>
            )}
            <p className="mt-1.5 text-[18px] leading-relaxed">{a.motivation}</p>
            <p className="mt-1 text-[16px] text-muted">
            ...
            {a.status === "approved" && !a.userId && (
              <p className="mt-2 text-[16px] text-rose-deep">
