...
export default function StaffManager({
  ...
  return (
    <div className="px-[18px] py-5">
      ...
      <p className="mb-3 rounded-card border border-line bg-white p-3 text-[17px] leading-relaxed text-muted">
        ...
        {rows.map((m) => (
          ...
          >
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-[16px] text-muted">가입 {m.joinedAt}</p>
            </div>
            {m.role !== "superadmin" && (
              <button
                type="button"
