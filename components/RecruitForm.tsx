...
export default function RecruitForm() {
  ...
  return (
    <form action={action} className="mt-6 flex flex-col gap-4">
      ...
      <fieldset>
        <legend className="mb-2 text-[18px] font-bold">관심 분야</legend>
      ...
      <div className="rounded-card border border-rose-soft bg-rose-soft/50 p-4">
        <h4 className="text-[18px] font-bold text-rose-deep">
          ⚖ 기자 책임 서약 (필수)
        </h4>
        <div className="mt-2 flex flex-col gap-2 text-[17px] leading-relaxed text-ink">
          <p>
        ...
        <label className="mt-3 flex items-start gap-2 text-[18px] font-bold">
          <input
            type="checkbox"
            name="pledge"
